...
var update = __webpack_require__(251)("9276126a", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
      ...
      fields: [{
        ...
        formatter: function formatter(_ref2) {
          var language = _ref2.language,
              language_title = _ref2.language_title;

          return language === "*" ? _this.$t("ALL_LANGUAGE") : language_title;
        }
      }]
    }, _defineProperty(_ref5, "toolbar", {
      type: "list",
      custom: [{
    ...
    }), _defineProperty(_ref5, "searchbar", {
      fields: [{
        key: "search",
  ...
  created: function created() {
    this.$_optionMixin_updateFieldList({ menu_category: 2, language: 3, viewlevel: 4 }, true);
  },

  methods: {
    handleCheckout: function handleCheckout(_ref6) {
      var _this2 = this;
    ...
    handleUpdateState: function handleUpdateState(_ref10) {
      var _this4 = this;
