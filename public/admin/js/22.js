...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mixins_edit__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mixins_edit_cms__ = __webpack_require__(283);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: { TypeForm: function TypeForm() {
      return __webpack_require__.e/* import() */(1/* duplicate */).then(__webpack_require__.bind(null, 111));
    } },
  ...
  data: function data() {
    return {
      fields: {
        ...
        type: {
          list: [{
            name: this.$t("OPTION_EXTRAFIELD_TYPE_TEXT"),
            value: "text"
          }, {
            ...
            value: "datetime"
          }, { name: this.$t("OPTION_EXTRAFIELD_TYPE_IMAGE"), value: "image" }, { name: this.$t("OPTION_EXTRAFIELD_TYPE_COLOR"), value: "color" }],
          custom_attrs: {
            label: "name",
            value: "value"
          }
      ...
      this.$$api_field_save({
        ...
        fn: function fn(_ref2) {
          ...
          _this.$_editMixin_onSubmitFinish({
            msg: msg,
            btn_type: btn_type,
            query: { id: submit_data.id = data.items.id || submit_data.id }
          });
        }
      });
    },
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.defaultValue.type
                        ? _c("TypeForm", {
                            attrs: {
                              data: _vm.defaultValue,
                              type: _vm.defaultValue.type
                            }
                          })
                        : _vm._e()
                    ],
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        model: {
                          value: _vm.defaultValue.required,
                          callback: function($$v) {
                            _vm.$set(_vm.defaultValue, "required", $$v)
                          },
                          expression: "defaultValue.required"
                        }
                      },
                      [
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        model: {
                          value: _vm.defaultValue.group_id,
                          callback: function($$v) {
                            _vm.$set(_vm.defaultValue, "group_id", $$v)
                          },
                          expression: "defaultValue.group_id"
                        }
                      },
