webpackJsonp([85,73],Array(107).concat([
/* 107 */
...
var baseIsNative = __webpack_require__(296),
    getValue = __webpack_require__(299);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_normalizr__ = __webpack_require__(283);
...
var listCacheClear = __webpack_require__(321),
    ...
    listCacheGet = __webpack_require__(323),
    listCacheHas = __webpack_require__(324),
    listCacheSet = __webpack_require__(325);
...
var mapCacheClear = __webpack_require__(314),
    ...
    mapCacheGet = __webpack_require__(328),
    mapCacheHas = __webpack_require__(329),
    mapCacheSet = __webpack_require__(330);
...
var isArray = __webpack_require__(16),
    ...
    toString = __webpack_require__(345);
...
var castPath = __webpack_require__(302),
...
var arrayPush = __webpack_require__(311),
    isFlattenable = __webpack_require__(332);
...
var apply = __webpack_require__(334);
...
var baseSetToString = __webpack_require__(336),
    shortOut = __webpack_require__(338);
...
var constant = __webpack_require__(337),
    defineProperty = __webpack_require__(312),
...
var MapCache = __webpack_require__(301),
...
var memoizeCapped = __webpack_require__(343);
...
var memoize = __webpack_require__(344);
...
var SetCache = __webpack_require__(339),
    arrayIncludes = __webpack_require__(353),
    arrayIncludesWith = __webpack_require__(358),
    arrayMap = __webpack_require__(310),
...
var baseFindIndex = __webpack_require__(355),
    baseIsNaN = __webpack_require__(356),
    strictIndexOf = __webpack_require__(357);
...
var update = __webpack_require__(258)("a727779c", content, false, {});
...
exports = module.exports = __webpack_require__(257)(false);
// imports
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_differenceBy__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mixins_option_mixin__ = __webpack_require__(284);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: { ItemList: function ItemList() {
      return __webpack_require__.e/* import() */(79).then(__webpack_require__.bind(null, 102));
    } },
  props: {
    moduleType: {
      type: String,
    ...
    return {
      ...
      default_value: {
        ...
        "categories-items": {
          category_ids: [],
          item_count: 0,
          item_order_by: "ordering",
          item_order: "desc",
          split_items_by_categories: false,
          featured_display: 0,
          featured_count: 0,
          featured_order_by: "featured_ordering",
          featured_order: "desc",
          split_items_by_featured: false
        },
        categories: {
          category_ids: []
        },
  ...
  methods: {
    ...
    getCountValue: function getCountValue(count) {
      return !count > 0;
    },
    setFieldValue: function setFieldValue(fields) {
      var _this = this;
    ...
    initFormData: function initFormData() {
      ...
      if (this.moduleType === "categories-items") {
        this.setFieldValue(["item_count", "featured_count"]);
      }
    }
  }
});
...
var baseDifference = __webpack_require__(350),
    ...
    baseRest = __webpack_require__(359),
...
var ListCache = __webpack_require__(294),
    Map = __webpack_require__(292),
    MapCache = __webpack_require__(301);
...
var Stack = __webpack_require__(361),
    equalArrays = __webpack_require__(363),
    equalByTag = __webpack_require__(387),
...
var Symbol = __webpack_require__(17),
    Uint8Array = __webpack_require__(388),
    eq = __webpack_require__(303),
    equalArrays = __webpack_require__(363),
...
var getAllKeys = __webpack_require__(392);
...
var baseGetAllKeys = __webpack_require__(393),
    getSymbols = __webpack_require__(394),
...
var arrayFilter = __webpack_require__(395),
      ...
      _vm.moduleType === "categories-items"
        ? [
            _c(
              ...
              {
                attrs: {
                  label: _vm.$t("OPTION_ITEM_COUNT" /*顯示項目總數量*/),
                  prop: "item_count"
                }
              },
              [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            model: {
                              value: _vm.fields.item_count.all,
                              callback: function($$v) {
                                _vm.$set(_vm.fields.item_count, "all", $$v)
                              },
                              expression: "fields.item_count.all"
                            }
                          },
                          _vm._l(_vm.fields.item_count.list, function(option) {
                            return _c("el-option", {
                              key: option.value,
                              attrs: {
                                label: option.label,
            ...
            _c(
              "el-form-item",
              {
                attrs: {
                  label: _vm.$t(
                    "OPTION_ITEM_SPLIT_ITEMS" /*是否依照分類區隔資料？*/
                  ),
                  prop: "split_items_by_categories"
                }
              },
              [
                _c(
            ...
            _c(
              ...
              {
                attrs: {
                  label: _vm.$t("OPTION_ORDER_BY" /*排序依據*/),
                  prop: "item_order_by"
                }
              },
              [
            ...
            _c(
              ...
              {
                attrs: {
                  label: _vm.$t("OPTION_FEATURED_DISPLAY" /*精選項目*/),
                  prop: "featured_display"
                }
              },
              [
                _c(
              ...
              ? [
                  _c(
                    "el-form-item",
                    {
                      attrs: {
                        label: _vm.$t(
                          "OPTION_FEATURED_SPLIT_ITEMS" /*是否置頂？*/
                        ),
                        prop: "split_items_by_featured"
                      }
                    },
                    [
                      _c(
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    {
                                      model: {
                                        value: _vm.fields.featured_count.all,
                                        callback: function($$v) {
                                          _vm.$set(
                                            _vm.fields.featured_count,
                                            "all",
                                            $$v
                                          )
                                        },
                                        expression: "fields.featured_count.all"
                                      }
                                    },
                                    _vm._l(
                                      _vm.fields.featured_count.list,
                                      function(option) {
                                        return _c("el-option", {
                                          key: option.value,
                                          attrs: {
                  ...
                  _c(
                    "el-form-item",
                    {
                      attrs: {
                        label: _vm.$t(
                          "OPTION_FEATURED_ORDER_BY" /*精選排序依據*/
                        ),
                        prop: "featured_order_by"
                      }
                    },
                    [
                      _c(
                  ...
                  _c(
                    ...
                    {
                      attrs: {
                        label: _vm.$t("OPTION_FEATURED_ORDER" /*精選排序方式*/),
                        prop: "featured_order"
                      }
                    },
                    [
