...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isEmpty__ = __webpack_require__(341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_pick__ = __webpack_require__(362);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: { FieldFormItem: function FieldFormItem() {
      return __webpack_require__.e/* import() */(79).then(__webpack_require__.bind(null, 404));
    } },
  props: {
    fields: {
      type: Array,
  ...
  watch: {
    fields: {
      handler: function handler() {
        if (__WEBPACK_IMPORTED_MODULE_1_lodash_isEmpty___default()(this.data)) {
          var fields = new __WEBPACK_IMPORTED_MODULE_0_normalizr__["b" /* schema */].Entity("fields");
          var normalize_list = Object(__WEBPACK_IMPORTED_MODULE_0_normalizr__["a" /* normalize */])(this.fields, [fields]);
    ...
    rules: function rules() {
      ...
      var fields = new __WEBPACK_IMPORTED_MODULE_0_normalizr__["b" /* schema */].Entity("fields", undefined, {
        ...
        processStrategy: function processStrategy(entity) {
          return __WEBPACK_IMPORTED_MODULE_2_lodash_pick___default()(entity, "required");
        }
      });
...
var basePick = __webpack_require__(363),
    flatRest = __webpack_require__(368);
...
var basePickBy = __webpack_require__(364),
...
var baseGet = __webpack_require__(305),
    baseSet = __webpack_require__(365),
    castPath = __webpack_require__(286);
...
var assignValue = __webpack_require__(366),
    castPath = __webpack_require__(286),
    isIndex = __webpack_require__(98),
    isObject = __webpack_require__(97),
    toKey = __webpack_require__(283);
...
var baseAssignValue = __webpack_require__(367),
...
var flatten = __webpack_require__(369),
