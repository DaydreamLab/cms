...
class DataHelper
{
    public const CUSTOMER_MESSAGE_TYPES =  [
        '產品詢價',
        '客訴反應',
        '合作提案',
        '技術問題',
    ...
    public const CUSTOMER_MESSAGE_STATUS =  ['待處理', '處理中', '已處理', '不需處理'];
    public const cities_order = [
        '基隆市', '臺北市', '新北市', '桃園市', '新竹縣', '新竹市','苗栗縣', '臺中市', '彰化縣',
        '南投縣', '雲林縣', '嘉義縣', '嘉義市', '臺南市', '高雄市','屏東縣', '宜蘭縣', '花蓮縣',
        '臺東縣', '澎湖縣', '金門縣', '連江縣', '釣魚臺', '南海島'
    ];
