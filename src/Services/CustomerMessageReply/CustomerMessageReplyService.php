...
namespace DaydreamLab\Cms\Services\CustomerMessageReply;
...
class CustomerMessageReplyService extends CmsService
{
    protected $modelName = 'CustomerMessageReply';

    public function __construct(CustomerMessageReplyRepository $repo)
    {
