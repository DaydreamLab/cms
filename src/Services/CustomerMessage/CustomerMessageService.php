...
namespace DaydreamLab\Cms\Services\CustomerMessage;

use DaydreamLab\Cms\Repositories\CustomerMessage\CustomerMessageRepository;
use DaydreamLab\Cms\Services\CmsService;
use Illuminate\Support\Collection;

class CustomerMessageService extends CmsService
{
    protected $modelName = 'CustomerMessage';

    public function __construct(CustomerMessageRepository $repo)
    {
