...
use DaydreamLab\Cms\Requests\Extrafield\Admin\ExtrafieldAdminImportPost;
...
class ExtrafieldAdminController extends CmsController
{
    ...
    public function import(ExtrafieldAdminImportPost $request)
    {
        $this->service->setUser($request->user('api'));
        $this->service->import($request->validated());
